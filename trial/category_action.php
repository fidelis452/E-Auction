...
if(isset($_POST["action"]))
{
	...
	{
		$order_column = array('Category', 'category_status');
		...
		{
			$search_query .= 'WHERE Category LIKE "%'.$_POST["search"]["value"].'%" ';
		...
		{
			$order_query = 'ORDER BY CategoryID DESC ';
		}
	...
	if($_POST["action"] == 'Add')
	{
		...
		{
			$data = array(
				':Category'			=>	$object->clean_input($_POST["Category"]),
